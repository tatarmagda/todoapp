...
import 'package:lol2/screens/todoapp.dart';
...
class _MyHomePageState extends State<MyHomePage> {
        ...
        drawer: Drawer(
          child: ListView(
            children: [
              DrawerHeader(
                decoration:
                    const BoxDecoration(color: Color.fromARGB(255, 70, 70, 70)),
                child: Stack(
                  children: [
                    Row(
                      children: [
  ...
  Future launchEmail() async {
    ...
    const subject = "Job proposition";
    const body = "Good Mornig Mrs Magda!";
    final email =
